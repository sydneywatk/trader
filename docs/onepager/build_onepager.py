  ...
  <div class="cols">
    ...
    <div class="col">
      ...
      <ul>
        ...
        <li>Win rate on faithful runs <b>~61%</b> vs his reported <b>~76%</b>; the gap is hand discretion (one daily &ldquo;top pick,&rdquo; chart reads, early exits), not a coding error.</li>
